...
<html lang="en">
    ...
    <body>
        ...
        <br>
        <h5 class="text-center mb-0"><small><b>SOLICITUD DE SERVICIO DE MANTENIMIENTO DE BIEN ACTIVOS </b></small></h5>
        <br>
        ...
        <p class="text-lefth mb-0">Descripción del bien:<b> {{$servicios->mueble}}</b> &nbsp;&nbsp; Marca:<b> {{$servicios->razon}}</b>&nbsp;&nbsp;Modelo: <b>{{$servicios->modelo}}</b></p>                            
        <p class="text-lefth mb-0">Oficina: <b>{{$solicitudes->area}}</b></p> 
        <p class="text-lefth mb-0">Con cargo a: <b>{{$solicitudes->areacargo}}</b></p>
        <p class="text-lefth mb-0">Resguardante: <b></b> </p>               
        <p class="text-center mt-0 mb-0">Trabajo a realizarse:</p>
