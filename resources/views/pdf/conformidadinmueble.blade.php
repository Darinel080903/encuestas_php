...
<html lang="en">
    ...
    <body>
        ...
        <br>
        <p class="text-lefth mb-0">Conformidad de trabajo realizado a bien inmueble</p><br>
        
        <p class="text-lefth mb-0">Servicios: <b>{{$servicios->descripcion}}</b></p>                    
        <p class="text-lefth mb-0">Dirección: <b>{{$servicios->inmueble}}</b></p>
        <p class="text-lefth mb-0">Oficina: <b>{{$solicitudes->areacargo}}</b></p>
        {{-- <p class="text-lefth mb-0">Trabajo realizado por el proveedor:<b></b></p> --}}
