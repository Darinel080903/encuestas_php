                        ...
                        <form class="needs-validation" method="POST" action="{{url('/facturas/'.$datos->idfactura)}}" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control @error('numero') is-invalid @enderror" id="numero" name="numero" placeholder="Número económico" maxlength="50" value="{{$datos->numero}}" required/>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="monto" name="monto" placeholder="Monto" maxlength="15" value="{{$datos->monto}}" readonly/>
                                </div>
