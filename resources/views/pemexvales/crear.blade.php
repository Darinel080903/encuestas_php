...
@section('content')
    ...
    <script>
        ...
        function FolioGuardar()
        {
            ...
            if(valida == true)
            {
                Detalle.push({factura:vfactura, facturafolio:vfacturafolio, concepto:vconcepto, conceptotexto:vconceptotexto, folioini:vfolioini, foliofin:vfoliofin, numero:vfolionumero, unitario:parseFloat(vfoliounitario), monto:parseFloat(vfoliomonto)});    
                $("#vdetalle").val("");
