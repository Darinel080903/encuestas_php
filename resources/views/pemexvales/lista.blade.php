                                ...
                                <thead>
                                    ...
                                    <th class="text-center" width="18%" scope="col" colspan="3">
                                        @can('create', \App\Models\Vpemexvale::class)
                                            <a class="btn btn-outline-danger" href="{{url('/pemexvales/create?page='.$page.'&vfecha='.$vfecha.'&vcomprobacion='.$vcomprobacion.'&vbusqueda='.$vbusqueda)}}"><i class="fas fa-save"></i></a>
                                        @endcan
                                    </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" width="6%">
                                            @can('update', $item)
                                                <a class="btn btn-outline-danger" href="{{url('/pemexvales/'.$item->idvale.'/edit?page='.$page.'&vfecha='.$vfecha.'&vcomprobacion='.$vcomprobacion.'&vbusqueda='.$vbusqueda)}}"><i class="fas fa-pen"></i></a>
                                            @endcan
                                        </td>
                                        <td class="text-center" width="6%">
                                            <a class="btn btn-outline-danger" href="{{url('/imprimir/pemexvale/'.$item->idvale)}}" target="_blank"><i class="fas fa-print"></i></a>
                                        </td>
                                        <td class="text-center" width="6%">
                                            @can('delete', $item)
