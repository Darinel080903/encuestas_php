                                    ...
                                    <div class="card-body">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="checkbox" class="form-control" id="otorga" name="otorga" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="responsable">Responsable UI:</label><br>
                                                <input type="checkbox" class="form-control" id="responsable" name="responsable" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger">
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="checkbox" class="form-control" id="elabora" name="elabora" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="solicita">Solicita:</label><br>
                                                <input type="checkbox" class="form-control" id="solicita" name="solicita" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="autoriza">Autoriza:</label><br>
                                                <input type="checkbox" class="form-control" id="autoriza" name="autoriza" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="valida">Valida:</label><br>
                                                <input type="checkbox" class="form-control" id="valida" name="valida" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger">
                                            </div>
                                        </div>
                                    </div>
                                </div>
