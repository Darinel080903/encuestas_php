            ...
            <div class="col-md-12">
                <div class="card cardborde">
                    <div class="card-header justify-content-between align-items-centr text-center encabezadoform">
                        <h3 class="headerlistatitulo"><i class="fas fa-pen"></i> Editar mueble</h3>
                    </div>
                    <div class="card-body">     
                        <form class="needs-validation" method="POST" action="{{url('/serviciomuebles/'.$solicitudes->idsolicitud)}}" novalidate>
                        @method('PUT')
                        @csrf
                            <div class="form-row">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" value="{{ $servicios->descripcion}}" maxlength="250" placeholder="descripcion">                                        
                                        </div>                                       
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" id="mueble" name="mueble">
                                                ...
                                                @foreach ($muebles as $item)
                                                    @if ($servicios->fkmueble == $item->idmueble)
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" id="razon" name="razon">
                                                ...
                                                @foreach ($razones as $item)
                                                    @if ($servicios->fkrazon == $item->idrazon)
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="modelo" name="modelo" value="{{$servicios->modelo}}" maxlength="11" placeholder="modelo">                                        
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label for="fechaservicio">Fecha servicio Activo:</label>
                            ...
                            <div class="p-3 border">
                                ...
                                <a  class="btn btn-outline-danger" href="{{url('/formatos/solicitudmueble/'.$solicitudes->idsolicitud)}}" target="_blank"><i class="fas fa-save"></i> Solicitud de servicio</a>  
                                <a  class="btn btn-outline-danger" href="{{url('/formatos/conformidadmueble/'.$solicitudes->idsolicitud)}}" target="_blank"><i class="fas fa-save"></i> Formato de conformidad</a>  
