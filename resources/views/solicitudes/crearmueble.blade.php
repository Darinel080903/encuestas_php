            ...
            <div class="col-md-12">
                <div class="card cardborde">
                    <div class="card-header justify-content-between align-items-centr text-center encabezadoform">
                        <h3 class="headerlistatitulo"><i class="fas fa-save"></i> Nuevo mueble</h3>
                    </div>
                    <div class="card-body">
                        <form class="needs-validation" method="POST" action="{{url('/serviciomuebles')}}" novalidate>
                        @csrf
                            ...
                            <div class="card border-success mb-2" id="muebles">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="modelo" name="modelo" value="{{old('modelo')}}" maxlength="11" placeholder="modelo">                                            
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" id="fechaservicio" name="fechaservicio" aria-label="fechaservicio" placeholder="fechaservicio" value="{{ old('fecha') }}" readonly/>
                                        </div>                                       
                                    </div>
                                </div>                     
                            </div>
