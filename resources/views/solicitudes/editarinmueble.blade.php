            ...
            <div class="col-md-12">
                <div class="card cardborde">
                    <div class="card-header justify-content-between align-items-centr text-center encabezadoform">
                        <h3 class="headerlistatitulo"><i class="fas fa-pen"></i> Editar inmueble</h3>
                    </div>
                    <div class="card-body">     
                        <form class="needs-validation" method="POST" action="{{url('/servicioinmuebles/'.$solicitudes->idsolicitud)}}" novalidate>
                        @method('PUT')
                        @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">                               
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('clave') is-invalid @enderror" id="clave" name="clave" value="{{$solicitudes->clave}}" maxlength="25" placeholder="clave" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" id="inmueble" name="inmueble">
                                                ...
                                                @foreach ($inmuebles as $item)
                                                    @if ($servicios->fkinmueble == $item->idinmueble)
                                        ...
                                        <div class="form-group col-md-2">
                                            <label for="fechaservicio">Fecha servicio inmueble:</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="ajuste" name="ajuste"  value="{!! number_format((float)($solicitudes->ajuste), 2) !!}" placeholder="ajuste" maxlength="11"/>
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
