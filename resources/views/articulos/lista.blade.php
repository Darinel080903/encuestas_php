                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" scope="col" colspan="2" width="22%"><a class="btn btn-outline-danger" href="{{url('/articulos/create?page='.$page.'&vbusqueda='.$vbusqueda)}}"><i class="fas fa-save"></i> Nuevo</a></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" width="11%"><a class="btn btn-outline-danger" href="{{url('/articulos/'.$item->idarticulo.'/edit?page='.$page.'&vbusqueda='.$vbusqueda)}}"><i class="fas fa-pen"></i> Editar</a></td>
